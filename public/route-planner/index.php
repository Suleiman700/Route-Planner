                    ...
                    <div class="card-header pb-0">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-4 mb-2">
                                <input type="text" id="inputPassword6" class="form-control" placeholder="Search for location..." aria-describedby="passwordHelpInline" onfocus="focused(this)" onfocusout="defocused(this)">
                            </div>
                            <div class="col-12 col-md-1">
